...
#define ORIGINAL_FILE_NAME "UE4Editor-Shooter_OW_Style.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Shooter_OW_Style
...
#define SHOOTER_OW_STYLE_API DLLEXPORT
